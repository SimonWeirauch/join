...
async function login() {
    ...
    if (user) {
        ...
        window.location.href = `https://simon-weirauch.de/join/html-sub/summary.html?msg=login&login=true`;
    }
    else {
...
function guestLogin() {
    ...
    window.location.href = 'https://simon-weirauch.de/join/html-sub/summary.html?msg=guest';
}
 ...
 */
function openSignUp() {
    window.location.href = 'https://simon-weirauch.de/join/html-sub/sign_up.html';
}
