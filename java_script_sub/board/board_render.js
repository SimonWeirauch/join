...
/**
 * displays the progress on the tasks
 * @param {Integer} resultProgress integer to display the progress on the task
 * @param {Integer} doneSubtaskCount integer to display the done subtasks
 * @param {Integer} allSubtaskCount integer to display all subtasks
 * @returns HTML-element
 */
...
/**
 * generate profile badges in the board
 * @param {String} initials contact initials
 * @param {String} badgeColor color of the badge
 * @param {Integer} pixelLeft defines the pixels to let the badges overlap
 * @returns HTML-element
 */
...
/**
 * generate profile badge in task overlay
 * @param {String} initials contact initials
 * @param {String} badgeColor color of the badge
...
/**
 * generates status of a subtask
 * @param {Integer} id id of the task
 * @param {Array-Element} subtask a specific subtask in the subtasks list
 */
 ...
 * @param {Integer} id id of the task
 * @param {Array-Element} subtask a specific subtask in the subtasks list
 * @param {String} currentImg string of the current image
 * @param {String} newImg string of the new image
 * @param {String} newStatusText string of the new status
 * @returns 
 */
