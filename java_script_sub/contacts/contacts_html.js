            ...
            <section class="overlay-right">
                ...
                <form id="onsubmit" onsubmit="createContact(); return false;">
                    <div class="overlay-right-form">
                        ...
                        <div id="errorMsgName" class="requiredFieldName dNone"></div>
...
/**
 * renders categories for in the contact page
...
/**
 * creates the category HTML-elements
 * @param {String} category id for HTML-element
 * @returns HTML-Element
 */
