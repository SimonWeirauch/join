...
async function registerUser(){
    ...
    if(await checkName()){
        ...
        else{showMsgBoxInvalidConfirmation();}
    };
}
...
function exactlyTwoNames(){
    document.getElementById('signupMsgBoxName').classList.remove('dNone');
    document.getElementById('signupMsgBoxName').innerHTML = /*html*/`
...
function openSuccessfullRegistered(){
    window.location.href = 'https://simon-weirauch.de/join/index.html?msg=userregistered';
}
...
function changeBorderOnFocus(id){
    ...
    document.getElementById('signupMsgBoxName').classList.add('dNone');
 ...
 */
function openLogin(){
    window.location.href = 'https://simon-weirauch.de/join/index.html';
}
...
function openPrivacy(){
    window.open('https://simon-weirauch.de/join/html-sub/privacy_data_protection_external.html', '_blank');
}
 ...
 */
function openLegal(){
    window.open('https://simon-weirauch.de/join/html-sub/legal_notice_external.html', '_blank');
}


/**
 * shows confirmation of registration
 */
async function openSignUpOverlay() {
    elementByID("signupLegalPrivacy").classList.add("dNone");
    elementByID("screen").classList.add("dNone");
    elementByID("overlay-content-signup").classList.remove("slideOut");
    elementByID("overlay-bg-signup").classList.add("d-flex");
    elementByID("overlay-bg-signup").classList.remove("dNone");
    elementByID("overlay-content-signup").classList.add("slide-in");
    elementByID("overlay-content-signup").style.right = "0";
    elementByID("overlay-content-signup").addEventListener("animationend", onAnimationEnd);
    function onAnimationEnd() {
        elementByID("overlay-content-signup").removeEventListener("animationend", onAnimationEnd);
        elementByID("overlay-bg-signup").classList.remove("dNone");        
    }  
}
